        ...
        >
          <div className="flex flex-col items-center">
            <motion.div 
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-blue-500 bg-white dark:bg-dark-800"
            >
          ...
          <div className="flex flex-col pb-8">
            <div className="flex flex-col sm:flex-row sm:items-center">
              <h3 className="text-xl font-bold text-gray-900 dark:text-dark-50">{exp.title}</h3>
              <p className="text-sm text-gray-500 dark:text-dark-400 sm:ml-4">{exp.period}</p>
            </div>
            <p className="text-lg text-blue-600 dark:text-blue-400 mt-1">{exp.company}</p>
            <ul className="mt-2 text-gray-600 dark:text-dark-300 list-disc list-inside space-y-2">
